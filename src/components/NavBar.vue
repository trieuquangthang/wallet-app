<template>
  <div class="bl__cont">
    <div class="bl__cont--nav">
      ...
      <div class="bl__nav--menu ">
        <svg class="svg__icon svg__qr bl__animation" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
          viewBox="0 0 29 29">
          <path
